...
export default function MemoHook() {
  ...
  return (
    ...
    <span style={{margin:100,}}>
      ...
      <button style={{backgroundColor:"pink" , border:.25   , height:50,width:300 ,borderRadius:100 }} type="button" onClick={handleIncrementTwo}>
    ...
    <button style={{backgroundColor:"pink" , border:.25   , height:50,width:300 ,borderRadius:100 }} type="button" onClick={handleIncrementOne}>
